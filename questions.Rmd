...
The results might raise an eyebrow or two. I'll point out that profiles in IN,ID
and Other are skewed towards lower memory and this contributes the prevalence of
*No* (despite that ID is very strongly *No*!)
